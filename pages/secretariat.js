                                ...
                                <div className="container px-2 mx-auto">
                                    ...
                                    <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-2">
                                        ...
                                        <div className="px-12 py-8 transition-colors duration-200 transform border rounded-xl">
                                            ...
                                            <p className="mt-4 text-gray-500">Daniel Cai was eternal leader of the Hackley Model USSR before its collapse after the fall of the Hackley Model Berlin Wall. Mr. Cai was known for his persecution of the Co-Secretaries General, which was a leading factor in the coup against him. After the coup attempt, Mr. Cai seeked refuge in Hanover, New Hampshire. Currently, Mr. Cai is an amateur basketball player that is unable to dunk. Mr. Cai was born in Batman, Turkey, where he was born as Bruce Wayne, before legally changing his name before assuming office as Eternal General Secretary of the now-defunct Hackley Model USSR.</p>
