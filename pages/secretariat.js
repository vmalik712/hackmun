                    ...
                    <div className="container px-2 mx-auto">
                        ...
                        <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-2">
                            ...
                            <div className="px-12 py-8 transition-colors duration-200 transform border rounded-xl">
                                ...
                                <p className="mt-4 text-gray-500">Advith Sharma is a Secretary-General in HackMUN this year. He is currently a junior and has been doing Model UN since 9th grade, and has really grown to enjoy it. He has experienced many different types of MUNs, including in-person and virtual conferences! He is very passionate about geography and global affairs as well as traveling the world and founded multiple GEO Clubs in his school to teach younger students. He also enjoys supporting environmental sustainability in the energy industry through economics and international finance and business. He looks forward to once again chairing a committee at HackMUN and a very fun experience for all delegates! </p>
